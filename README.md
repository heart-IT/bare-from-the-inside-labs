...
Labs 01–04 and 06 were tested with Node.js 18.20.8, 20.19.4 and 22.21.0, and lab 05 with 22.21.0 (its `bare-pack` crashes under 20.19.4); all on macOS. Lab 06 also needs a C compiler (the Xcode Command Line Tools). Node launches things; the probes run under Bare.
